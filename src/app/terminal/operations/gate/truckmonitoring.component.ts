...
@Component({
  selector: 'app-truckmonitoring',
  templateUrl: './truckmonitoring.component.html',
  styleUrls: ['./truckmonitoring.component.scss']
})
export class TruckmonitoringComponent implements OnInit {

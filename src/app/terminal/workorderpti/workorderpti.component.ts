...
@Component({
  selector: 'app-workorderpti',
  templateUrl: './workorderpti.component.html',
  styleUrls: ['./workorderpti.component.scss']
})
export class WorkorderptiComponent implements OnInit {

...
@Component({
  selector: 'app-containermovementinquiry',
  templateUrl: './containermovementinquiry.component.html',
  styleUrls: ['./containermovementinquiry.component.scss']
})
export class ContainermovementinquiryComponent implements OnInit {

...
@Component({
  selector: 'app-portarealist',
  templateUrl: './portarealist.component.html',
  styleUrls: ['./portarealist.component.scss']
})
export class PortarealistComponent implements OnInit {

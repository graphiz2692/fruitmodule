...
@Component({
  selector: 'app-movementrules',
  templateUrl: './movementrules.component.html',
  styleUrls: ['./movementrules.component.scss']
})
export class MovementrulesComponent implements OnInit {
